           ...
           $.each(data,(i,value)=>{
               ...
               meses=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiempre","Octubre"]
                ...
                var dateformat =  date.getUTCDay() + " " + "de" + " "  + meses[date.getMonth()] + " " + "de" + " " + date.getUTCFullYear() + " " + " " + " " +date.getHours() + ":" + date.getMinutes() 
                 ...
                 var blockauthor  = '<div class="two wide column ">  </div> <div class=  " fourteen wide column"> <h3> Pubicado por: ' + " " +  trabajo  +  " " + '<br>'  + 'El'+" " + dateformat + '<br><br>'  + "categoria:" + " " + '<strong> '  +  value.categoria  + '</strong> </h3></div>'
                 var blocktitulo  = '<div class="two wide column ">  </div> <div class=  " fourteen wide column"><h3> Se ' + " " + value.modalidad + ":" + " " +  value.descripcion + '</h3></div>'            

                 var  mainblock =  '<div class="ui segment elements"> <div class="ui grid  ">' +  blockauthor +  blocktitulo + ' </div></div>'
           ...
           $.post('/avisos/all/json', {categoria:categoria}).done((data)=>{
               ...
               var date = new Date(value.creado);
                ...
                var dateformat =  date.getUTCDay() + " " + "de" + " "  + meses[date.getMonth()] + " " + "de" + " " + date.getUTCFullYear() + " " + " " + " " +date.getHours() + ":" + date.getMinutes() 
                 ...
                 var blockauthor  = '<div class="two wide column ">  </div> <div class=  " fourteen wide column"> <h3> Pubicado por: ' + " " +  trabajo  +  " " + '<br>'  + 'El'+" " + dateformat + '<br>'  + "categoria:" + " " + '<strong> '  +  value.categoria  + '</strong> </h3></div>'
                 var blocktitulo  = '<div class="two wide column ">  </div> <div class=  " fourteen wide column"><h3> Se ' + " " + value.modalidad + ":" + " " +  value.descripcion + '</h3></div>'            
